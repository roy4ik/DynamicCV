/**
 * FloatLabels
 * URL: https://clubdesign.github.io/floatlabels.js/
...
// function addWorkSection(sectionID) {
//     if (sectionID == "exp") {
//         // sectionNumber++;
//         parentSection = document.getElementsByClassName("formSectionExperience")[0];
//         formSubSection = document.getElementsByClassName("formsSubSectionExperience")[0];
//         newInputSection = formSubSection;
//         newInput = document.createElement("input");
//         newInput.type = "text";
//         newInput.setAttribute("ng-model", "employer2");
//         newInput.placeholder = "Employer"
//         newInput.class = "floatlabel";
//         newInput.id = "employer2";


//         parentSection.appendChild(newInputSection);
//         newInputSection.appendChild(newInput);

//         parentOutputSection = document.getElementsByClassName("expSection")[0];
//         newOutput = document.createElement("p");
//         newOutput.innerHTML = "{{employer2}}";
//         parentOutputSection.appendChild(newOutput)
//     }
// }
